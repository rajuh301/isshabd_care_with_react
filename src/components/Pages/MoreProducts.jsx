...
const MoreProducts = ({ pro }) => {
    const { _id, name, imagePaths, rating, price, discount, brand } = pro;
                ...
                <div className="card card-compact w-72 bg-base-300 shadow-xl md:mb-0 mb-5">
                    ...
                    <Link to={`/product/${_id}`}>
                        <button>
                            ...
                            <figure><img className='w-72 h-52 rounded-lg' src={img} /></figure>
                            <p className='absolute top-0 rounded-full bg-yellow-300 font-bold'>{offer ? offer : ''}%</p>
                            <div className="card-body ">
                                ...
                                <div className="rating justify-center">
                                    <Rating
                                        ...
                                        emptySymbol={<span className='text-yellow-600 text-2xl'>☆</span>}
                                ...
                                <div className='flex items-center text-left'>
                                    <p className='font-bold'>Old Price : <span className='text-red-500 text-1xl font-bold line-through'>{discount} TK </span> </p>
